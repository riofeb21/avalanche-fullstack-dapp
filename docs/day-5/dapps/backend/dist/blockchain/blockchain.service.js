...
let BlockchainService = class BlockchainService {
    ...
    constructor() {
        this.client = (0, viem_1.createPublicClient)({
            ...
            transport: (0, viem_1.http)(process.env.RPC_URL || "https://api.avax-test.network/ext/bc/C/rpc"),
        });
        this.contractAddress = (process.env.CONTRACT_ADDRESS || "0x23b9c596b547f001b2c3577edf5e039f07bff8a5");
    }
